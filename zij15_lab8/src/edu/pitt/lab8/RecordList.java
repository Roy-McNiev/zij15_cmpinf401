...
public class RecordList {
	...
	public int add(Record data) {
		...
		if (currentNode == null || currentNode.data.getTime() >= data.getTime()) currentNode = head;
		else {
		...
		Node newNode = new Node(data), originalNode = currentNode.next;
	...
	public void writeToFile(String filename) {
		...
		try {
			...
			while (currentNode != null) {
				bufferedWriter.write(currentNode.data.getName() + ", " + 
			currentNode.data.getTime() + "\n");
				currentNode = currentNode.next;
			}
